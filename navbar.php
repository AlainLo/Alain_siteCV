      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="index_public.php">Réalisations</a></li>
            <li><a href="index_public.php">Expériences</a></li>
            <li><a href="index_public.php">Formations</a></li>
           <li role="separator" class="divider"></li>
            <li><a href="index_public.php">Compétences</a></li>
            <li><a href="index_public.php">Loisirs</a></li>
             <!--<li role="separator" class="divider"></li>
